...
class MainPage:
    ...
    def open_menu(self):
        self.__driver.find_element(By.CSS_SELECTOR, '[data-testid="header-member-menu-avatar"]').click()
    ...
    def get_account_info(self) -> list[str]:
        ...
        (WebDriverWait(self.__driver, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[data-testid="account-menu-account-section"]'))))
