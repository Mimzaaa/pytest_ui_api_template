...
class AuthPage:
    ...
    def login_as(self, email: str, password: str ):
        ...
        # Ожидаем появление поля ввода логин
        (WebDriverWait(self.__driver, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#username"))))
        ...
        (WebDriverWait(self.__driver, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#password"))))
